...
<head>
    ...
    <style>
        ...
        .card-body {
            ...
            display: -webkit-box;
            -webkit-line-clamp: 6; /* Adjusted to show more lines */
        ...
        .navbar-nav .nav-item.bg-success:hover .nav-link {
            background-color: #4CAF50;
        }
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item"><a class="nav-link active fw-bold" href="./index.php">Home</a></li> <!-- Fixed Path -->
                    <li class="nav-item"><a class="nav-link fw-bold" href="about_us.php">About Us</a></li>
                    <li class="nav-item"><a class="nav-link fw-bold" href="display_all.php">Products</a></li> <!-- Fixed Path -->
                            ...
                            <div class='col-md-4 mb-2'>
                                <div class='card'>
                                    ...
                                    <div class='card-body'>
                                        ...
                                        <a href='index.php?add_to_cart=$product_id' class='btn btn-success fw-bold italic'>Add to cart</a>
                                        <a href='product_details.php?product_id=$product_id' class='btn btn-secondary fw-bold italic'>View More</a>
                                    </div>
                                </div>
                            </div>";
                        }
            ...
            <ul class="navbar-nav me-auto text-center">
                ...
                if ($result_categories && mysqli_num_rows($result_categories) > 0) {
                    while ($row_data = mysqli_fetch_assoc($result_categories)) {
                        ...
                        echo "<li class='nav-item'>
                                <a href='index.php?category=$category_id' class='nav-link text-light fw-bold category-link'>$category_title</a>
                              </li>";
                    }
                } else {
                    echo "<li class='nav-item'>
...
<div style="background-color: #90EE90; padding: 10px; text-align: center;">
    <p style="font-weight: bold;">&copy; 2024 Kasun's Handmades. All Rights Reserved. | Designed by Dhammika.</p>
</div>
